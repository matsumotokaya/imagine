...
// The sheet is moved (resized) to adjust the visible range; its content always
// flows from the top of the sheet and only scrolls when it exceeds the largest detent.
